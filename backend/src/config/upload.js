...
module.exports = { // exporta um objeto com varias configurações
  ...
  storage: multer.diskStorage({ //storage são as forma de salver, diskStorage é o mecanismo de armazenamento em DISCO, Existem duas opções disponíveis destination e filename
    ...
    //__dirname `usado para indicar o diretorio atual, nesse caso acima a pasta config, dessa forma infomamos que ele iniciara desta pasta pra chegar ao destino
    ...
    filename: (req, file, cb) => { 
      ...
      // a data é utilizada para que um arquivo com mesmo noe substitua outro
    },
  }),
};